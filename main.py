...
def main2():
	...
	(WARRIOR_DATA,warrior_sheet,warrior_animation_steps)=load_warrior()
	(WIZARD_DATA,WIZARD_sheet,WIZARD_animation_steps)=load_wizardF()
	(ONI_DATA,ONI_sheet,ONI_animation_steps)=load_ONI()
	round_number=1
	...
	character2=Character(2,1200,510,True,ONI_DATA,ONI_sheet,ONI_animation_steps)
	game_running=True
